...
def arg_parser():
    ...
    p.add_argument('-d', default='.', help='ghostwriter directory',
                   metavar='ONIONSHARE_DIR', dest='ghostwriter_dir')
...
def main():
    ...
    dir = args.ghostwriter_dir

    src = files_in(dir, 'ghostwriter') + files_in(dir, 'ghostwriter_gui')
